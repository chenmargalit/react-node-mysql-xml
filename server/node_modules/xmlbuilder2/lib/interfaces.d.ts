 ...
 * serialized nodes.
 */
export declare type XMLSerializedValue = string | XMLSerializedMap | XMLSerializedArray | XMLSerializedObject;
declare type XMLSerializedObject = {
    [key: string]: XMLSerializedValue;
};
